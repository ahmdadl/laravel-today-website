<nav x-data="{ open: false }" class="fixed top-0 left-0 z-10 w-full bg-green-700 border-b border-green-300 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600">
