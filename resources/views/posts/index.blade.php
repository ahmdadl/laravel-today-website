<x-app-layout>
    ...
    <div class='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-2 gap-x-0 sm:gap-x-2 md:gap-x-3'>
        @forelse($posts as $post)
            <article
                class='relative m-1 bg-gray-200 border border-gray-700 rounded dark:border-gray-300 dark:bg-gray-900'>
                ...
                <div class='p-2'>
                    ...
                    <div class='grid grid-cols-3 text-center'>
                        <span class="text-xl text-center">
                            <x-button bg='green' icon='fas fa-thumbs-up' clear='1'></x-button>
                        </span>
                        <span class='text-xl text-center text-gray-700 dark:text-gray-500'>
                            54654
                        </span>
                        <span class="text-xl text-center">
                            <x-button bg='red' icon='fas fa-thumbs-down' clear='1'></x-button>
                        </span>
                    </div>
                </div>
            </article>
