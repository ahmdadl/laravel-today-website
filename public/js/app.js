...
function () {
  ...
  Notify.prototype.fire = function (name, message) {
    if (name === void 0) {
      name = 'info';
  ...
  Notify.prototype.warn = function (message) {
...
var $notify = new Notify(); // @ts-ignore
